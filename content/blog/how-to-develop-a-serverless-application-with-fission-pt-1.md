...
In order to run the function, you can create a `python` environment easily through the fission CLI with command:

```bash
# fission env create --name <env name> --image <runtime container image>
$ fission env create --name python --image fission/python-env
```

## Create user function

We'll be using the python Hello World example as our first function. 

```bash
$ curl https://raw.githubusercontent.com/fission/fission/master/examples/python/hello.py > hello.py
```

Then, create the function with environment name and the code we just download.

```bash
# fission fn create --name <function name> --env <env name> --code <file name>
$ fission fn create --name hello --env python --code hello.py
```

We can use a CLI built-in command to test the function first!
...
```bash
$ fission fn logs -f --name hello
```

Then, the logs of function pod will be printed. 

```bash
[2018-08-22 08:16:48.803475814 +0000 UTC] 2018-08-22 08:16:48,798 - INFO - Starting bjoern based server
[2018-08-22 08:16:49.58664819 +0000 UTC] 2018/08/22 08:16:49 Fetcher ready to receive requests
[2018-08-22 08:17:08.499443459 +0000 UTC] 2018/08/22 08:17:08 fetcher received fetch request and started downloading: {1 {hello-py-ydpj  default    0 0001-01-01 00:00:00 +0000 UTC <nil> <nil> map[] map[] [] nil [] }   user [] [] false}
[2018-08-22 08:17:08.695734021 +0000 UTC] 2018/08/22 08:17:08 Successfully placed at /userfunc/user
[2018-08-22 08:17:08.695754142 +0000 UTC] 2018/08/22 08:17:08 Checking secrets/cfgmaps
[2018-08-22 08:17:08.695767835 +0000 UTC] 2018/08/22 08:17:08 Completed fetch request
[2018-08-22 08:17:08.695770578 +0000 UTC] 2018/08/22 08:17:08 elapsed time in fetch request = 196.500461ms
```-->
